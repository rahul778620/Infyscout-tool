...
export class MasterService  {
  ...
  console.log(searchstring)
    const headers = new HttpHeaders({
     ...
     //Authorization : "Basic TmV3Q29kZXItUmFqMjI6Z2hwXzFUZlhLeXRwOHV6cW0xNFBJdVlDejFUa0JrNVNoODNLc21mNw==",
     'Authorization': 'Basic UmFqLVJpY29oOmdocF8xYTc1WGdYbGtPMjg1a3lrYmFKazFXMnVHQWRLZUgxQnNzajg=',
      Accept:'application/vnd.github.text-match+json'
    });
    this.apiurl=this.apiurl+"q="+searchstring+"+org:"+gitorg+"&per_page=100&Page=10"
    console.log(this.apiurl)
    this.str5=searchstring;
   ...
   generateExcel(userlist: any)
  {
    ...
    const header = ['File Name', 'File Extension', 'File Path', 'Impacted Code'];
...
// Generate Excel File with given name
  ...
  this.filesaver.save(blob,this.str5)
